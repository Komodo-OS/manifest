...
[![Build Status](https://jenkins.komodo-os.my.id/job/komodo-os-all/badge/icon?style=flat-square&subject=Build%20Jenkins)](https://jenkins.komodo-os.my.id/job/komodo-os-all/)
